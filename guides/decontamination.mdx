...
description: "Scan planned output for conversation residue, agent-control residue, version ghosts, and model-prior claims before writing any content to project files."
---
