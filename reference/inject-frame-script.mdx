---
title: "inject_frame.py — Canon Boundary Guard Hook Payload Script"
sidebarTitle: "inject_frame.py"
description: "inject_frame.py reads frame.md and emits a JSON hook payload for Codex PreToolUse, surfacing the provenance frame before each matched write tool call."
---
