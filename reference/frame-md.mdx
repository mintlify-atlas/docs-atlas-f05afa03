...
description: "The compact classification frame injected before write tools: six layer definitions, the AGENTS.md prelude rule, and inline tagging and persistence rules."
---
