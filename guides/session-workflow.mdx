...
description: "A practical end-to-end workflow for running a full Codex session with Canon Boundary Guard active — from activation through analysis, editing, and write decisions."
---
