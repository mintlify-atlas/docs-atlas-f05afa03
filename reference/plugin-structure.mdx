...
description: "The Canon Boundary Guard plugin layout: marketplace manifest, plugin.json manifest, skill files, hook configuration, and the inject_frame script, all under plugins/canon-boundary-guard-codex/."
---
