---
title: "hooks.json — PreToolUse Hook Configuration"
sidebarTitle: "hooks.json"
description: "The hooks.json file wires the inject_frame.py script to the Codex PreToolUse lifecycle event for write tools, re-injecting the compact provenance frame before apply_patch, Write, and Edit."
---
